...
describe("Cucumber.Runtime", function() {
  ...
  var runtimeTests = function(strictMode) {
    var configuration;
    var runtime;
    ...
    beforeEach(function() {
      ...
      spyOnStub(configuration,"isStrictMode").andReturn(strictMode);
    ...
    describe("start()", function() {
      ...
      it("creates a new AST tree walker", function() {
        runtime.start(callback);
        expect(Cucumber.Runtime.AstTreeWalker).toHaveBeenCalledWith(features, supportCodeLibrary, listeners,strictMode);
      });
