...
describe('Cucumber.Runtime', function () {
    ...
    beforeEach(function () {
        listeners = createSpyWithStubs('listener collection', {
            add: null
        });
    ...
    describe('start()', function () {
        ...
        beforeEach(function () {
            ...
            astTreeWalker = createSpyWithStubs('AST tree walker', {
                walk: null
            });
    ...
    describe('getFeatures()', function () {
        ...
        beforeEach(function () {
            ...
            features = createSpy('features (AST)');
            parser = createSpyWithStubs('parser', {
                parse: features
            });
