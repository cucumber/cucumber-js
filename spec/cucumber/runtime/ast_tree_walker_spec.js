...
describe('Cucumber.Runtime.AstTreeWalker', function () {
    ...
    beforeEach(function () {
        features = createSpyWithStubs('Features AST element', {
            acceptVisitor: null
        });
        ...
        spyOnStub(listeners, 'syncForEach').andCallFake(function (cb) {
            listeners.forEach(cb);
        });
        spyOnStub(supportListeners, 'syncForEach').andCallFake(function (cb) {
            supportListeners.forEach(cb);
        });
        spyOnStub(supportCodeLibrary, 'getListeners').andCallFake(function () {
    ...
    describe('walk()', function () {
        ...
        it('visits all features with a callback', function () {
            ...
            expect(treeWalker.visitFeatures).toHaveBeenCalledWithValueAsNthParameter(features, 1);
            expect(treeWalker.visitFeatures).toHaveBeenCalledWithAFunctionAsNthParameter(2);
        });
    ...
    describe('visitBackground()', function () {
        var background, callback, event, payload, scenario;
    ...
    describe('broadcastAfterEvent()', function () {
        ...
        beforeEach(function () {
            ...
            event = createSpyWithStubs('Event', {
                replicateAsPostEvent: postEvent
            });
            callback = createSpy('Callback');
            spyOn(treeWalker, 'broadcastEvent');
        });
    ...
    describe('skipStep()', function () {
        ...
        it('creates a new skipped step result', function () {
            ...
            expect(Cucumber.Runtime.SkippedStepResult).toHaveBeenCalledWith({
                step: step
            });
        });
    ...
    describe('skipUndefinedStep()', function () {
        ...
        beforeEach(function () {
            ...
            payload = {
                stepResult: undefinedStepResult
            };
        ...
        it('creates a new undefined step result', function () {
            ...
            expect(Cucumber.Runtime.UndefinedStepResult).toHaveBeenCalledWith({
                step: step
            });
        });
