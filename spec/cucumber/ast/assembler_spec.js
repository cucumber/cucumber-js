...
describe('Cucumber.Ast.Assembler', function () {
    ...
    describe('applyCurrentFeatureTagsToElement()', function () {
        ...
        beforeEach(function () {
            element = createSpyWithStubs('AST element', {
                addInheritedtags: null
            });
            featureTags = createSpy('feature tags');
            feature = createSpyWithStubs('current feature', {
                getTags: featureTags
            });
    ...
    describe('applyStashedTagsToElement()', function () {
        ...
        beforeEach(function () {
            element = createSpyWithStubs('any AST element accepting tags', {
                addTags: null
            });
    ...
    describe('insertBackground()', function () {
        ...
        beforeEach(function () {
            ...
            currentFeature = createSpyWithStubs('current feature', {
                addBackground: null
            });
    ...
    describe('insertDataTableRow()', function () {
        ...
        beforeEach(function () {
            ...
            currentStep = createSpyWithStubs('current step', {
                attachDataTableRow: null
            });
    ...
    describe('insertStep()', function () {
        var step, currentScenarioOrBackground;

        beforeEach(function () {
            step = createSpy('step');
            currentScenarioOrBackground = createSpyWithStubs('current scenario or background', {
                addStep: null
            });
    ...
    describe('convertScenarioOutlinesToScenarios()', function () {
        ...
        beforeEach(function () {
            ...
            scenarioOutline = createSpyWithStubs('scenario', {
                'buildScenarios': subScenarios
            });
    ...
    describe('convertScenarioOutlinesToScenarios()', function () {
        ...
        beforeEach(function () {
            ...
            currentFeature = createSpyWithStubs('currentFeature', {
                'getFeatureElements': scenarios
            });
    ...
    describe('isSuggestedFeatureEnrollable() [suggestFeature()]', function () {
        ...
        describe('when a feature is suggested', function () {
            ...
            beforeEach(function () {
                feature = createSpyWithStubs('suggested feature', {
                    hasFeatureElements: null
                });
