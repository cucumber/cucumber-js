...
describe('Cucumber.TagGroupParser', function () {
    ...
    describe('.getTagGroupsFromStrings()', function () {
        var tagGroupStrings, getTagGroupsFromStringsFunc, tagGroups, tagGroupParsers;
        ...
        beforeEach(function () {
            ...
            tagGroupParsers = [createSpyWithStubs('first tag group parser', {
                    parse: tagGroups[0]
                }),
                                     createSpyWithStubs('second tag group parser', {
                    parse: tagGroups[1]
                }),
                                     createSpyWithStubs('third tag group parser', {
                    parse: tagGroups[2]
                })];
