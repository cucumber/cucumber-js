...
describe('Cucumber.Cli.SupportCodeLoader', function () {
    ...
    beforeEach(function () {
        supportCodeFilePaths = [
            createSpyWithStubs('first secondary support code file path', {
                match: false
            }),
            createSpyWithStubs('first prime support code file path', {
                match: true
            }),
            createSpyWithStubs('second prime support code file path', {
                match: true
            }),
            createSpyWithStubs('second secondary support code file path', {
                match: false
            })
        ];
    ...
    describe('buildSupportCodeInitializerFromPaths()', function () {
        ...
        describe('returned wrapper function', function () {
            var initializers, returnedWrapperFunction, supportCodeHelper, nonInitializerSupportCode;
            var nonInitializerSupportCodeCalled;

            beforeEach(function () {
                nonInitializerSupportCode = {
                    call: function () {
                        nonInitializerSupportCodeCalled = true;
                    }
                };
