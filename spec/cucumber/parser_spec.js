...
describe('Cucumber.Parser', function () {
    ...
    beforeEach(function () {
        ...
        featureSources = [
            ['(feature:1)', createSpyWithStubs('first feature source', {
                toString: 'first feature source'
            })],
            ['(feature:2)', createSpyWithStubs('second feature source', {
                toString: '# language: fr\nsecond feature source'
            })]
        ];
    ...
    describe('parse()', function () {
        ...
        beforeEach(function () {
            gherkinENLexer = createSpyWithStubs('English gherkin lexer instance', {
                scan: null
            });
            gherkinFRLexer = createSpyWithStubs('French gherkin lexer instance', {
                scan: null
            });
    ...
    describe('handleBackground()', function () {
        var keyword, name, description, line, uri, background;
    ...
    describe('handleDocString()', function () {
        var contentType, string, uri, line, docString;
    ...
    describe('handleFeature()', function () {
        var keyword, name, description, uri, line, feature;
    ...
    describe('handleDataTableRow()', function () {
        var cells, uri, line, dataTableRow;
    ...
    describe('handleScenario()', function () {
        var keyword, name, description, uri, line, scenario;
    ...
    describe('handleStep()', function () {
        var keyword, name, uri, line, step;
