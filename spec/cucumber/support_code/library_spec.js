...
describe('Cucumber.SupportCode.Library', function () {
    ...
    describe('Step Definitions', function () {
        ...
        beforeEach(function () {
            stepDefinitionCollection = [
                createSpyWithStubs('First step definition', {
                    matchesStepName: false
                }),
                createSpyWithStubs('Second step definition', {
                    matchesStepName: false
                }),
                createSpyWithStubs('Third step definition', {
                    matchesStepName: false
                })
            ];
            spyOnStub(stepDefinitionCollection, 'syncForEach').andCallFake(function (cb) {
                stepDefinitionCollection.forEach(cb);
            });
    ...
    describe('Listener Support', function () {
        ...
        beforeEach(function () {
            listeners = [
        createSpyWithStubs('First listener', {
                    setHandlerForEvent: null
                }),
        createSpyWithStubs('Second listener', {
                    setHandlerForEvent: null
                }),
        createSpyWithStubs('Third listener', {
                    setHandlerForEvent: null
                })
      ];
        ...
        describe('when the default World constructor is replaced by a custom one', function () {
            it('instantiates a custom World', function () {
                ...
                rawSupportCode = function () {
                    this.World = customWorldConstructor;
                };
                library = Cucumber.SupportCode.Library(rawSupportCode);
