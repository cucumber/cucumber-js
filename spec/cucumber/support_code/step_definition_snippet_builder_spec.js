...
describe('Cucumber.SupportCode.StepDefinitionSnippetBuilder', function () {
    ...
    describe('parameterizeStepName()', function () {
        ...
        beforeEach(function () {
            ...
            parameterizedExamplesStepName = createSpyWithStubs('step name with parameterized numbers', {
                replace: parameterizedStepName
            });
            parameterizedNumbersStepName = createSpyWithStubs('step name with parameterized numbers', {
                replace: parameterizedExamplesStepName
            });
            stepName = createSpyWithStubs('step name', {
                replace: parameterizedNumbersStepName
            });
        });
