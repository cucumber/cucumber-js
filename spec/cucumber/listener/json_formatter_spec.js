...
describe('Cucumber.Listener.JsonFormatterWrapper', function () {
    ...
    describe('handleBackgroundEvent()', function () {
        ...
        var parentFeatureEvent, background, step, steps, event, callback, feature;
        ...
        beforeEach(function () {
            ...
            parentFeatureEvent = createSpyWithStubs('event', {
                getPayloadItem: feature
            });
    ...
    describe('handleBeforeScenarioEvent()', function () {
        var parentFeatureEvent, scenario, callback, feature, event;
    ...
    describe('formatTags()', function () {
        ...
        it('filters out any tags it is told to ignore - e.g. those of the parent feature', function () {
            ...
            expect(listener.formatTags(tags, parentTags)).toEqual([
                {
                    name: 'tag_one',
                    line: 1
                },
    ...
    describe('handleStepResultEvent()', function () {
        var callback, stepResult, step, fakeEvent;
        ...
        it('outputs a step with failed status where no result has been defined', function () {
            ...
            fakeEvent = createSpyWithStubs('event', {
            ...
            expect(formatter.result).toHaveBeenCalledWith({
                status: 'failed'
            });
            expect(formatter.match).toHaveBeenCalledWith({
                location: undefined
            });
