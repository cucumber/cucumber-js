...
describe('Cucumber.Listener.PrettyFormatter', function () {
    ...
    describe('constructor', function () {
        ...
        it('creates a summaryFormatter', function () {
            expect(Cucumber.Listener.SummaryFormatter).toHaveBeenCalledWith({
                logToConsole: false
            });
        });
    });
    ...
    describe('handleBeforeFeatureEvent()', function () {
        var event, feature, keyword, name, callback, description, tags;

        beforeEach(function () {
            keyword = 'feature-keyword';
            name = 'feature-name';
            description = 'feature-description';
            tags = [createSpyWithStubs('tags', {
                getName: '@tag'
            })];
    ...
    describe('handleBeforeScenarioEvent()', function () {
        var event, scenario, keyword, name, callback, backgroundStepLength, scenarioStepLength, tags, line, uri, background;
        ...
        beforeEach(function () {
            ...
            background = createSpyWithStubs('background', {
                getMaxStepLength: backgroundStepLength
            });
            scenario = createSpyWithStubs('scenario', {
                getKeyword: keyword,
                getName: name,
                getMaxStepLength: scenarioStepLength,
                getUri: uri,
                getLine: line,
    ...
    describe('handleStepResultEvent()', function () {
        var event, stepResult, keyword, name, step, callback, uri, maxStepLength, line;
    ...
    describe('logDataTable()', function () {
        var dataTable, rows, stepResult, step;
        ...
        beforeEach(function () {
            ...
            dataTable = createSpyWithStubs('data table', {
                raw: rows
            });
            spyOn(prettyFormatter, 'logIndented');
        });
    ...
    describe('logDocString()', function () {
        var docString, contents, stepResult, step;
        ...
        beforeEach(function () {
            ...
            docString = createSpyWithStubs('doc string', {
