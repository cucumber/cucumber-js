...
describe("Cucumber.Listener.PrettyFormatter", function() {
  ...
  beforeEach(function() {
    failedStepResults = Cucumber.Type.Collection();
  ...
  describe("handleStepResultEvent()", function() {
    ...
    beforeEach(function() {
      step = createSpyWithStubs("step", { getKeyword: "Given", getName: " foo" });
      ...
      spyOn(process.stdout, 'write'); // avoid output from intefering with jasmine
    });
  ...
  describe("Logging of step results", function() {
    var result, step;

    beforeEach(function() {
      step = createSpyWithStubs("step spy", {
