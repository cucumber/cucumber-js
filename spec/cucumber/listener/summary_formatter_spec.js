...
describe('Cucumber.Listener.SummaryFormatter', function () {
    ...
    var formatter, formatterHearMethod, summaryFormatter, statsJournal, failedStepResults, options, color;
    ...
    describe('storeFailedScenario()', function () {
        ...
        beforeEach(function () {
            ...
            failedScenario = createSpyWithStubs('failedScenario', {
                getName: name,
                getUri: uri,
                getLine: line
            });
    ...
    describe('storeUndefinedStep()', function () {
        ...
        beforeEach(function () {
            ...
            snippetBuilderSyntax = createSpyWithStubs('snippet builder syntax', {
                getNumberMatchingGroup: numberMatchingGroup
            });
            step = createSpy('step');
            snippet = createSpy('step definition snippet');
            snippetBuilder = createSpyWithStubs('snippet builder', {
    ...
    describe('logFailedStepResults()', function () {
        ...
        describe('for each failed step result', function () {
            var userFunction, failedStep, forEachCallback, failedStepResult;
    ...
    describe('logFailedStepResult()', function () {
        ...
        beforeEach(function () {
            ...
            stepResult = createSpyWithStubs('failed step result', {
    ...
    describe('logScenariosSummary()', function () {
        var scenarioCount, passedScenarioCount, pendingScenarioCount, failedScenarioCount, undefinedScenarioCount;
        ...
        describe('when there are no scenarios', function () {
            beforeEach(function () {
                statsJournal.getScenarioCount.andReturn(0);
            });
        ...
        describe('when there are scenarios', function () {
            beforeEach(function () {
                statsJournal.getScenarioCount.andReturn(12);
            });

            describe('when there is one scenario', function () {
                beforeEach(function () {
                    statsJournal.getScenarioCount.andReturn(1);
                });
            ...
            describe('when there are 2 or more scenarios', function () {
                beforeEach(function () {
                    statsJournal.getScenarioCount.andReturn(2);
                });
            ...
            describe('when there are no failed scenarios', function () {
                beforeEach(function () {
                    statsJournal.getFailedScenarioCount.andReturn(0);
                });
            ...
            describe('when there is one failed scenario', function () {
                beforeEach(function () {
                    statsJournal.getFailedScenarioCount.andReturn(1);
                });
            ...
            describe('when there are two or more failed scenarios', function () {
                beforeEach(function () {
                    statsJournal.getFailedScenarioCount.andReturn(2);
                });
            ...
            describe('when there are no undefined scenarios', function () {
                beforeEach(function () {
                    statsJournal.getUndefinedScenarioCount.andReturn(0);
                });
            ...
            describe('when there is one undefined scenario', function () {
                beforeEach(function () {
                    statsJournal.getUndefinedScenarioCount.andReturn(1);
                });
            ...
            describe('when there are two or more undefined scenarios', function () {
                beforeEach(function () {
                    statsJournal.getUndefinedScenarioCount.andReturn(2);
                });
            ...
            describe('when there are no pending scenarios', function () {
                beforeEach(function () {
                    statsJournal.getPendingScenarioCount.andReturn(0);
                });
            ...
            describe('when there is one pending scenario', function () {
                beforeEach(function () {
                    statsJournal.getPendingScenarioCount.andReturn(1);
                });
            ...
            describe('when there are two or more pending scenarios', function () {
                beforeEach(function () {
                    statsJournal.getPendingScenarioCount.andReturn(2);
                });
            ...
            describe('when there are no passed scenarios', function () {
                beforeEach(function () {
                    statsJournal.getPassedScenarioCount.andReturn(0);
                });
            ...
            describe('when there is one passed scenario', function () {
                beforeEach(function () {
                    statsJournal.getPassedScenarioCount.andReturn(1);
                });
            ...
            describe('when there are two or more passed scenarios', function () {
                beforeEach(function () {
                    statsJournal.getPassedScenarioCount.andReturn(2);
                });
    ...
    describe('logStepsSummary()', function () {
        var stepCount, passedStepCount, failedStepCount, skippedStepCount, pendingStepCount, undefinedStepCount;
        ...
        describe('when there are steps', function () {
            beforeEach(function () {
                statsJournal.getStepCount.andReturn(13);
            });
