...
export async function convertConfiguration(
  ...
  return {
    ...
    runtime: {
      ...
      parallelStartupMode: flatConfiguration.parallelStartupMode,
      parallelRampSize: flatConfiguration.parallelRampSize,
      parallelRampDelay: flatConfiguration.parallelRampDelay,
