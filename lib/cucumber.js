var Cucumber = function(featureSource, supportCodeInitializer, options, worldParams) {
  var configuration = Cucumber.VolatileConfiguration(featureSource, supportCodeInitializer, options, worldParams);
