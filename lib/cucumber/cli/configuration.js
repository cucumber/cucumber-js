  ...
  var self = {
    getFormatter: function getFormatter() {
      ...
      case Configuration.PRETTY_FORMAT_NAME:
        ...
        break;
      case Configuration.TEAMCITY_FORMAT_NAME:
        formatter = Cucumber.Listener.TeamCityFormatter();
        break;
      case Configuration.JS_FORMAT_NAME:
        formatter = Cucumber.Listener.JSFormatter();
        break;
      default:
...
Configuration.TEAMCITY_FORMAT_NAME = "teamcity";
Configuration.JS_FORMAT_NAME = "js";
