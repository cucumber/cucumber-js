var ArgumentParser = function(argv) {
  ...
  var self = {
    ...
    getModularPartitioningOptions: function getModularPartitioningOptions() {
      var parts = self.getOptionOrDefault(ArgumentParser.PARTITIONS_COUNT);
      var remainder = self.getOptionOrDefault(ArgumentParser.PARTITIONS_REMAINDER, 0);
    ...
    getKnownOptionDefinitions: function getKnownOptionDefinitions() {
      ...
      definitions[ArgumentParser.PARTITIONS_COUNT]                 = Number;
      definitions[ArgumentParser.PARTITIONS_REMAINDER]             = Number;
...
ArgumentParser.PARTITIONS_COUNT                          = "parts";
ArgumentParser.PARTITIONS_REMAINDER                      = "remainder";
