function ArgumentParser(argv) {
  ...
  var self = {
    ...
    getSnippetSyntax: function getSnippetSyntax () {
      var options     = self.getOptions();
      var snippetSyntax = options[ArgumentParser.SNIPPET_SYNTAX_OPTION_NAME];
      if (snippetSyntax) {
        if (!path.isAbsolute(snippetSyntax)) {
          snippetSyntax = path.join(process.cwd(), snippetSyntax);
        }
        return require(snippetSyntax)();
      } else {
    ...
    getKnownOptionDefinitions: function getKnownOptionDefinitions() {
      ...
      definitions[ArgumentParser.SNIPPET_SYNTAX_OPTION_NAME]       = String;
...
ArgumentParser.SNIPPET_SYNTAX_OPTION_NAME                = 'snippet-syntax';
