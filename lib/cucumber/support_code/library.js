var Library = function(supportCodeDefinition) {
  ...
  var self = {
    ...
    instantiateNewWorld: function instantiateNewWorld(runtime, callback) {
      var world = new worldConstructor(onWorldConstructionComplete, runtime);

      function onWorldConstructionComplete(explicitWorld) {
