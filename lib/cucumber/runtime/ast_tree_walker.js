  ...
  var self = {
    ...
    visitFeature: function visitFeature(feature, callback) {
      ...
      self.broadcastEventAroundUserFunction(
        event,
        function(callback) {
          supportCodeLibrary.getBeforeCallbacks().forEach(function(beforeCallback, callback) {
            beforeCallback.invoke(world, callback)
          }, function() {
            feature.acceptVisitor(self, function() {
              supportCodeLibrary.getAfterCallbacks().forEach(function(afterCallback, callback) {
                afterCallback.invoke(world, callback)
              }, callback);
            });
          });
        },
