...
\n\
--parts COUNT                 Split up the tests into COUNT parts.\n\
                              This is to be used in conjunction with the\n\
                              --remainder option.\n\
\n\
--remainder REMAINDER         When the --parts option is specified, this\n\
                              option determines which set of tests to run\n\
                              out of the various partitions. This number\n\
                              is zero-indexed, so if --parts is 2, then\n\
