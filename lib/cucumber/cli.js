...
\n\
--compiler <file_extension>:<module_name>   Include step definitions and support files with the given file extension\n\
                                            and require the given module to make this possible.\n\
\n\
