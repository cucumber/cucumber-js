function Runtime(configuration) {
  ...
  var self = {
    start: function start(callback) {
      ...
      var isStrictRequested  = configuration.isStrictRequested() || false;
      var isDryRunRequested  = configuration.isDryRunRequested() || false;
      var features           = self.getFeatures();
      var supportCodeLibrary = self.getSupportCodeLibrary(isDryRunRequested);
