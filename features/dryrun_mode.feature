Feature: Dryrun mode
  ...
  Scenario: Skipped scenario with implemented step with --dry-run
  ...
  Scenario: Skipped scenario with passing step with --dry-run --strict
    Given a file named "features/step_definitions/cucumber_steps.js" with:
    """
    var cucumberSteps = function() {
      this.When(/^this step passes$/, function(callback) { callback(); });
  ...
  Scenario: Skipped scenario with implemented step with -d
    Given a file named "features/step_definitions/cucumber_steps.js" with:
    """
    var cucumberSteps = function() {
      this.When(/^this step passes$/, function(callback) { callback(); });
  ...
  Scenario: Undefined scenario with undefined step with -d -S
    When I run cucumber.js with `-f progress features/a.feature -d -S`
    Then it outputs this text:
    """
    U
